...
//making an array
let current_users:string[]=["amna","rehan","nouman","ayesha","zain"];

//making another array
let new_users:string[]=["alshaba","wajiha","rabia","nouman","amna"];
...
if(condition){
    ...
    else{console.log(`This username ${newoneUser} is available`)}
